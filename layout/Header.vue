<template>
    <header>
        <div class="topnavbar">
            <nuxt-link to="/" class="udemylink">
                <v-img src="https://www.udemy.com/staticx/udemy/images/v7/logo-udemy.svg" alt="Udemy Logo"
                    class="udemylogo" contain />
            </nuxt-link>
            <button>
